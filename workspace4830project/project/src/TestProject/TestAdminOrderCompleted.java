...
public class TestAdminOrderCompleted {
  ...
  @Test
  public void testAdminOrderCompleted() throws Exception {
	    ...
	    Thread.sleep(2000);
    driver.findElement(By.linkText("Complete one order? Let your customer know »")).click();
    Thread.sleep(2000);
    driver.findElement(By.name("ID")).clear();
    Thread.sleep(1000);
    driver.findElement(By.name("ID")).sendKeys("4");
    Thread.sleep(1000);
    ...
    Thread.sleep(1000);
    driver.findElement(By.xpath("(.//*[normalize-space(text()) and normalize-space(.)='Customer Name'])[1]/following::button[1]")).click();
    Thread.sleep(2000);
